...
import com.speedata.anima.BuildConfig;
...
public final class Logcat {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = AppAnima.getInstance().getPackageManager()
                    .getPackageInfo(AppAnima.getInstance().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && AppAnima.getInstance().getExternalCacheDir() != null) {
                sDefaultDir = AppAnima.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                sDefaultDir = AppAnima.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
